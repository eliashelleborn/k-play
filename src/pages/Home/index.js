...
const homelists = [
  {
    ...
    description:
      'Producerat av Kulturakademin i samarbete med Atalante under Destination Atalante den 10 december 2018.\nReine Jönsson writes music. His list of work includes five operas, music for symphony orchestra, chamber music and various experiments.\nModerator: Sara Björklund Jönsson\nLjudtekniker: Rasmus Persson & Viktor Wendin',
    url:
      'https://soundcloud.com/user-994747535/70-kompositor-reine-jonsson-om-tygdockor-musik-och-konstnarskap-live-2018-12-10',
    episodes: '#75',
    image:
      'https://images.unsplash.com/photo-1561212044-bac5ef688a07?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=934&q=80',
    subject: 'Konst',
    key: 7
  },
  {
    ...
    description:
      'Stråf Vocal Strings framför en del av sin föreställning Familia samt berättar om sin arbetsprocess och hur de möter den unga publiken. Stråf Vocal Strings består av Sanna Källman, Tobias Edvardsson, Francis Schaughnessy och Åsa Johansson.',
    url: 'https://www.youtube.com/watch?v=DyTBdvHvrbA',
    episodes: '1/2',
    image:
      'https://images.unsplash.com/photo-1499442711659-a9566695faed?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1950&q=80',
    subject: 'Musik',
    key: 10
  },
  {
    ...
    description:
      'Meet Netflix´s Lina Bronéus, Drirector of Co-Productions & Acquisitions, in a keynote talk about the growing importance of the international markets for Netflix and the company´s plans for the Nordics.',
    url: 'https://www.youtube.com/watch?v=qvWzFtNPbB4',
    episodes: '1/3',
    image:
      'https://images.unsplash.com/photo-1522869635100-9f4c5e86aa37?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1950&q=80',
    subject: 'Media',
    key: 0
  },
  {
  ...
  },
  {
    ...
    description:
      'Meet two of Italy´s top producers, Nicola Serra, Managing Director of Palomar and Marco Chimenz, Co-CEO of Cattleya, talking about their upcoming slates, trends in Italian drama and the new tv series The Name of the Rose. ',
    url: 'https://www.youtube.com/watch?v=uRkfLsPntFY',
    episodes: '1/1',
    image:
      'https://images.unsplash.com/photo-1555726383-c1240a1d4808?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=934&q=80',
    subject: 'TV',
    key: 1
  },
  {
  ...
  },
  {
    ...
    subtitle:
      'Multi award winning British television writer, producer and director Sally Wainwright ',
    description:
      'Multi award winning British television writer, producer and director Sally Wainwright (Happy Valley, Last Tango in Halifax) on her career and the art of writing.',
    url: 'https://www.youtube.com/watch?v=UmGkHDYJRk4',
    episodes: '1/1',
    image:
      'https://images.unsplash.com/photo-1486074051793-e41332bf18fc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=934&q=80',
    subject: 'Manus',
    key: 2
  },
  {
    type: 'PODD',
    title:
      'Do i really need a dramaturg? – Introduction into dance dramaturgy (LIVE: 2019-05-17)',
    subtitle:
      'In the field of dance, dramaturgy is still a relatively new discipline and a new profession, which is therefore still viewed with curiosity and suspicion',
    description:
    ...
    url:
      'https://soundcloud.com/user-994747535/110-do-i-really-need-a-dramaturg-introduction-into-dance-dramaturgy-live-2019-05-17',
    episodes: '#110',
  ...
  },
  {
    type: 'PODD',
    title:
      'Ekodesigndirektivet för ljuset – men går något konstnärligt förlorat (LIVE: 2019-05-16)',
    ...
    url:
      'https://soundcloud.com/user-994747535/105-ekodesigndirektivet-for-ljuset-men-gar-nagot-konstnarligt-forlorat-live-2019-05-16',
    episodes: '#105',
    image:
      'https://images.unsplash.com/photo-1483000805330-4eaf0a0d82da?ixlib=rb-1.2.1&auto=format&fit=crop&w=934&q=80',
    subject: 'Ljudteknik',
    key: 6
  },
  {
      ...
      {authUser ? (
        <div>
          <StyledBanner2 tint="rgba(0, 0, 0, 0.1)" image={BannerImage3} px="3">
            ...
            <BannerText3>
              Tipsa om kurser på KA Klippverktyget. Dela till kollegor/studenter
            </BannerText3>
          </StyledBanner2>
        </div>
      ) : (
